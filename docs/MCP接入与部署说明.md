...
2026-09-17 部署更新：下文保留 2026-09-11 的历史服务快照与接入说明。当前可分享配置以 config/mcp-servers.template.json 和[一次性部署说明](一次性部署说明.md)为准；传输字段已规范化，EUR-Lex 固定候选版本 0.12.1，尚未在本轮目标千问实启。
